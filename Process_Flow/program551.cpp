...
#define ERR_INSUFICIENT_SPACE -6
#define ERR_INSUFFICIENT DATA  -7
...
//  Description :       It is used to create new regualr file
//  Input :             It accepts name and premissions
...
int main()
{
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            else if(strcpy("clear",Command[0])== 0)
            {
                 #ifdef _WIN32
                    system("cls");
                #else
        ...
        else if(iCount == 3)
        {
            ...
            if(strcmp("creat",Command[0]) == 0)
            {
                ...
                {
                    printf("Error : Unable to create file as the file as parameters are Inavlid\n");
                ...
                if(iRet == ERR_MAX_FILES_OPEN)
                {
                    ...
                    printf("Max opned files limit reached\n");
                }
            }
