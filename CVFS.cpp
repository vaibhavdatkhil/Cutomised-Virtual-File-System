...
//  Description :       It is used to write the data in to the file
...
//  Description :       It is used to read the data in to the file
//  Input :             File descriptor
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            if(strcmp("unllink",Command[0]) == 0)
            {
                ...
                {
                    printf("Error : Uanble to delete as there is no such file");
                }
            ...
            else if(strcmp("write",Command[0]) == 0)
            {
                ...
                if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : inavlid parameters\n");
                }
                ...
                {
                    printf("%d bytes gets sucessfully  written",iRet);
                }
            }
            else
            {
